...
- [Rollback prediction correctness audit](plans/rollback-correctness-audit.md)
- [Feature 24 authoritative input provenance](plans/24-authoritative-input-provenance.md)
